...
import (
	...
	pb "github.com/Yujiman/e_commerce/basket/gatway/internal/proto/item"
...
func NewClient() *Client {
	return &Client{addr: config.GetConfig().ServicesParam.Item}
}

func (c Client) CreateOrder(itemId string) (*pb.Item, error) {
