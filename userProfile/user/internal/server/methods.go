...
import (
	...
	"github.com/Yujiman/e_commerce/goods/userProfile/user/internal/handler/addWithId"
...
func (Server) AddWithId(ctx context.Context, request *pb.AddWithIdRequest) (*pb.UUID, error) {
	return addWithId.Handle(ctx, request)
}
