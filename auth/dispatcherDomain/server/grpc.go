...
import (
	...
	"github.com/Yujiman/e_commerce/auth/dispatcherDomain/proto/dispatcherDomain"

	"google.golang.org/grpc"
)

type Server struct {
	dispatcherDomain.UnimplementedDispatcherDomainServiceServer
}
...
func InitServer() {
	...
	dispatcherDomain.RegisterDispatcherDomainServiceServer(grpcServer, &Server{})
