...
import (
	...
	"github.com/Yujiman/e_commerce/auth/aggregatorDomain/proto/aggregatorDomain"

	"google.golang.org/grpc"
)

type Server struct {
	aggregatorDomain.UnimplementedAggregatorDomainServiceServer
}
...
func InitServer() {
	...
	aggregatorDomain.RegisterAggregatorDomainServiceServer(grpcServer, &Server{})
