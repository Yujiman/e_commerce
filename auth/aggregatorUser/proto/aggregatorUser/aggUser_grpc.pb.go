...
type AggregatorUserServiceClient interface {
	...
	GetByIdDomain(ctx context.Context, in *GetByIdDomainRequest, opts ...grpc.CallOption) (*User, error)
	GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*User, error)
	GetByUsernameDomainUrl(ctx context.Context, in *GetByUsernameDomainUrlRequest, opts ...grpc.CallOption) (*User, error)
...
func (c *aggregatorUserServiceClient) GetByIdDomain(ctx context.Context, in *GetByIdDomainRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/aggregatorUser.AggregatorUserService/GetByIdDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aggregatorUserServiceClient) GetByUsernameDomainUrl(ctx context.Context, in *GetByUsernameDomainUrlRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/aggregatorUser.AggregatorUserService/GetByUsernameDomainUrl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AggregatorUserServiceServer interface {
	...
	GetByIdDomain(context.Context, *GetByIdDomainRequest) (*User, error)
	GetByUsername(context.Context, *GetByUsernameRequest) (*User, error)
	GetByUsernameDomainUrl(context.Context, *GetByUsernameDomainUrlRequest) (*User, error)
...
func (UnimplementedAggregatorUserServiceServer) GetByIdDomain(context.Context, *GetByIdDomainRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIdDomain not implemented")
}
...
func (UnimplementedAggregatorUserServiceServer) GetByUsernameDomainUrl(context.Context, *GetByUsernameDomainUrlRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByUsernameDomainUrl not implemented")
}
...
func _AggregatorUserService_GetByIdDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByIdDomainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorUserServiceServer).GetByIdDomain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aggregatorUser.AggregatorUserService/GetByIdDomain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorUserServiceServer).GetByIdDomain(ctx, req.(*GetByIdDomainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AggregatorUserService_GetByUsernameDomainUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByUsernameDomainUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorUserServiceServer).GetByUsernameDomainUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aggregatorUser.AggregatorUserService/GetByUsernameDomainUrl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorUserServiceServer).GetByUsernameDomainUrl(ctx, req.(*GetByUsernameDomainUrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AggregatorUserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetByIdDomain",
			Handler:    _AggregatorUserService_GetByIdDomain_Handler,
		},
		{
		...
		{
			MethodName: "GetByUsernameDomainUrl",
			Handler:    _AggregatorUserService_GetByUsernameDomainUrl_Handler,
		},
		{
			MethodName: "GetAll",
	...
	Metadata: "proto/aggregatorUser/aggUser.proto",
}
