...
type OAuthUserClient interface {
	AddWithId(ctx context.Context, in *AddWithIdRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *oAuthUserClient) AddWithId(ctx context.Context, in *AddWithIdRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/oauthUser.OAuthUser/AddWithId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OAuthUserServer interface {
	AddWithId(context.Context, *AddWithIdRequest) (*Empty, error)
...
func (UnimplementedOAuthUserServer) AddWithId(context.Context, *AddWithIdRequest) (*Empty, error) {
...
func _OAuthUser_AddWithId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddWithIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OAuthUserServer).AddWithId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/oauthUser.OAuthUser/AddWithId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OAuthUserServer).AddWithId(ctx, req.(*AddWithIdRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OAuthUser_AddWithId_Handler,
		},
		{
			MethodName: "Add",
